...
export default function Recipes() {
    const recipes = [
        ...
        {
            title: "Mom's Banana Pudding",
            description: "the one that gets requested",
            category: "dessert",
            ingredients: [
                {
                    name: "Bananas",
                ...
                {
                    name: "instant vanilla pudding mix (small box)",
                    quantity: "",
                    unit: ""
                },
                {
            ...
            directions: [
                {
                    explanation: "Slice bananas into 1/4 inch thick slices. Squeeze lemon juice acros banana slices.",
                },
                {
                    explanation: "Make the pudding mix. Don't use milk. Cut water in half.",
                },
                {
                    explanation: "Mix in cool whip and condensed milk",
                },
                {
                    explanation: "Start with pudding in bottom of bowl. Layer pudding, banana slices, pudding, wafers...repeating.",
                },
            ],
            notes: "Try for french vanilla pudding mix. Don't use milk. Cut water in half! Possibly put in freezer for easier assembly.",
            recipeCredit: {
                url: "",
                embedUrl: "",
                account: "",
